...
class CustomJSON(Task):
    ...
    def __init__(self, filepath, **kwargs):
        ...
        if not os.path.exists(filepath):
            ...
            print("This builder is configured for local-only data.")
            print("Create the JSONL file locally or publish a design to regenerate the identity conversations file.")
            print("-" * 80)
